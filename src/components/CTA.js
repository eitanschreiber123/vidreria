...
const CTA = () => {
  return (
    <section className="py-20 text-center bg-[url('/images/cta-bg.jpg')] bg-cover bg-center text-white relative">
      <div className="absolute inset-0 bg-black/70" />
      <div className="relative z-10">
        <h2 className="text-3xl mb-6">Transformamos tus ideas en realidad</h2>
